...
const dataVolumeServiceLevel = [
  { name: "Jan", Volume: 800, Services: 600 },
  { name: "Feb", Volume: 950, Services: 700 },
  { name: "Mar", Volume: 700, Services: 550 },
  { name: "Apr", Volume: 1100, Services: 800 },
  { name: "May", Volume: 900, Services: 650 },
  { name: "Jun", Volume: 1200, Services: 900 },
  { name: "Jul", Volume: 1135, Services: 635 }, // Matching screenshot values
];
    ...
    >
      ...
      <div>
        ...
        <p className={`text-xs flex items-center ${percentageColor}`}>
          {arrowIcon} {percentage}% from yesterday
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 bg-gray-50 min-h-screen font-sans">
      ...
      <div className="flex justify-between items-center mb-6">
        <button className="flex items-center px-4 py-2 rounded-lg text-gray-700 border border-gray-300 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 text-sm">
          <FaChartBar className="mr-2" /> Export
        </button>
      </div>
